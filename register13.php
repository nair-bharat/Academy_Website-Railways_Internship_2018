...
if($_SERVER['REQUEST_METHOD']=='POST'){
		...
		if($_POST['password']==$_POST['confirmpassword']){
			...
			$sql="INSERT into login13 (username,email,password)"."VALUES('$username','$email','$password')";
			
			if($mysqli->query($sql)==true){
				$_SESSION['message']='Registration successful! Added $username to the database!';
				$_SESSION['username'] = $username;
				header("location:home13.php");
...
<form class="form" name="myform" action="register13.php" method="post" onsubmit="return validateform()">
