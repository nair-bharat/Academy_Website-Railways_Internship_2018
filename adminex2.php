   ...
   $name = $_POST['name'];
	...
	$allowed= array('jpg','jpeg');
		...
		if(in_array($fileextension,$allowed))
		{
			...
			$query = "INSERT INTO employee(id,fname,designation,contact,image,imagename,age,dob,post,role)VALUES('$name','$des','$contact','$imgContent','$filedestination','$age','$dob','$doj','$role')";
...
window.location.href='executivecomitee.php';
</script>";
		}
...
if(isset($_POST['update'])){
	...
	mysqli_query($db,"UPDATE employee SET fname='$name',designation='$des',contact='$contact',image='$imgContent',imagename='$filedestination' WHERE srno=$id");
		}
	}
	header('location:executivecomitee.php');
}
