...
<a href="insertmembers.php"><button class="button3 button1" style="width:180px" "height:50px;">Add members</button></a>
<a href="updatemembers.php"><button class="button3 button1" style="width:180px" "height:50px;">Update members</button></a>
<a href="deletemembers.php"><button class="button3 button1" style="width:180px" "height:50px;">Delete members</button></a><br><br><br>
