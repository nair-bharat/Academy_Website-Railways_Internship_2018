...
if($_SERVER['REQUEST_METHOD']=='POST'){
		...
		if($_POST['password']==$_POST['confirmpassword']){
			...
			$sql="INSERT into login2 (username,email,password)"."VALUES('$username','$email','$password')";
...
<form class="form" name="myform" action="register2.php" method="post" onsubmit="return validateform()">
