...
if($_SERVER['REQUEST_METHOD']=='POST'){
		...
		if($_POST['password']==$_POST['confirmpassword']){
			...
			$sql="INSERT into login5 (username,email,password)"."VALUES('$username','$email','$password')";
...
<li><a href="login5.php">Login</a></li>
</ul>
</div>
</div>

<form class="form" name="myform" action="register5.php" method="post" onsubmit="return validateform()">
