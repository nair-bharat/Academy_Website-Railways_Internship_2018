...
if($_SERVER['REQUEST_METHOD']=='POST'){
		...
		if($_POST['password']==$_POST['confirmpassword']){
			...
			$sql="INSERT into login4 (username,email,password)"."VALUES('$username','$email','$password')";
...
<li><a href="login4.php">Login</a></li>
</ul>
</div>
</div>

<form class="form" name="myform" action="register4.php" method="post" onsubmit="return validateform()">
