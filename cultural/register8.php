...
if($_SERVER['REQUEST_METHOD']=='POST'){
		...
		if($_POST['password']==$_POST['confirmpassword']){
			...
			$sql="INSERT into login8 (username,email,password)"."VALUES('$username','$email','$password')";
			
			if($mysqli->query($sql)==true){
				$_SESSION['message']='Registration successful! Added $username to the database!';
				$_SESSION['username'] = $username;
				header("location:home8.php");
...
<li><a href="login8.php">Login</a></li>
</ul>
</div>
</div>

<form class="form" name="myform" action="register8.php" method="post" onsubmit="return validateform()">
